...
4. Interview transcription pipeline opens an OpenAI Realtime websocket per active interview and appends completed transcript segments into local interview storage.
